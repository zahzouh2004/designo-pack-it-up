...
const Footer = () => {
  return (
    <footer className="bg-designo-brown-dark text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="hover:text-designo-brown-light transition-colors">الرئيسية</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contact" className="hover:text-designo-brown-light transition-colors">اتصل بنا</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-700 text-center text-sm text-gray-300">
